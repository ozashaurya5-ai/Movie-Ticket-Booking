...
function bookNow() {
  ...
  if (movie.includes("Select") || date.includes("Select") || cinema.includes("Select") || time.includes("Select")) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeBtn?.addEventListener('click', () => {
    ...
    themeBtn.innerHTML = document.body.classList.contains('light') ? '<i class="ri-sun-line"></i>' : '<i class="ri-moon-line"></i>';
  });
  ...
  open?.addEventListener('click', () => { modal.style.display='grid'; modal.setAttribute('aria-hidden','false'); });
